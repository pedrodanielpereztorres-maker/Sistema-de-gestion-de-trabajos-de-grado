...
def fila_estudiante(estudiante) -> rx.Component:
    ...
    inicial_cell = rx.table.cell(
        rx.center(
            ...
            width="2.375rem", height="2.375rem", border_radius="0.625rem",
            background=GRAD_INDIGO,
            box_shadow="0 2px 8px rgba(99,102,241,0.25)",
            flex_shrink="0",
        ),
        style={"padding": f"{PAD_Y} {PAD_X}"}, white_space="normal",
    )
    ...
    tutor_cell = rx.table.cell(
        rx.cond(
            ...
            rx.vstack(
                ...
                rx.text(
                    rx.cond(estudiante.carrera_tutor, estudiante.carrera_tutor, "Carrera no asignada"),
                    style={
                        "font_size": "0.78rem",
                        "color": "#475569",
                        "font_weight": "500",
        ...
        rx.cond(
            ...
            rx.button(
                ...
                on_click=lambda _evt=None, e=estudiante: EstadoEstudiante.abrir_modal_empresa(
                    e.nombre_empresa, e.direccion_empresa, e.correo_empresa, e.telefono_empresa, e.tutor_empresa
                ),
            ),
            rx.text("—", style={"color": "#CBD5E1", "font_size": FS_BODY}),
        ),
    ...
    fecha_ini_cell = rx.table.cell(
        rx.hstack(
            ...
            rx.text(
                ...
                style={"font_size": "0.85rem", "color": "#334155",
                       "font_weight": "500", "white_space": "normal"}
            ),
            spacing="1", align="center"
        ),
        style={"padding": f"{PAD_Y} {PAD_X}"}, white_space="normal",
    ...
    fecha_fin_cell = rx.table.cell(
        rx.hstack(
            ...
            rx.text(
                ...
                style={"font_size": "0.85rem", "color": "#065F46",
                       "font_weight": "500", "white_space": "normal"}
            ),
            spacing="1", align="center"
        ),
