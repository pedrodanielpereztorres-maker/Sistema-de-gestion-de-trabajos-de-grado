            ...
            rx.hstack(
                ...
                rx.vstack(
                    ...
                    rx.cond(
                        ...
                        rx.badge(
                            "Pública", variant="soft", color_scheme="green", radius="full", font_size="0.6875rem",
                            style={
                        ...
                        rx.badge(
                            "Privada", variant="soft", color_scheme="gray", radius="full", font_size="0.6875rem",
                            style={
            ...
            rx.vstack(
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.text("Tutor Académico", font_size="0.75rem", font_weight="800",
                                color=COLOR_TEXTO_MUY_SUAVE, text_transform="uppercase"),
                        spacing="1", align="center",
                    ),
                    rx.text(tesis["tutor_academico"].to(str), font_size="0.875rem",
                ...
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.text("Tutor Empresarial", font_size="0.75rem", font_weight="800",
                                color=COLOR_TEXTO_MUY_SUAVE, text_transform="uppercase"),
                        spacing="1", align="center",
                    ),
                    rx.text(tesis["tutor_empresa"].to(str), font_size="0.875rem",
                            font_weight="600", color=COLOR_TEXTO_TITULO, no_of_lines=1),
                    spacing="1", align="start",
                ),
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.text("Empresa", font_size="0.75rem", font_weight="800",
                                color=COLOR_TEXTO_MUY_SUAVE, text_transform="uppercase"),
                        spacing="1", align="center",
                    ),
                    rx.text(tesis["nombre_empresa"].to(str), font_size="0.875rem",
                            font_weight="600", color=COLOR_TEXTO_TITULO, no_of_lines=1),
                    spacing="1", align="start",
                ),
                spacing="4", width="100%", align="start",
                padding_top="0.875rem", border_top=f"1px solid {COLOR_BORDE}",
            ),
            ...
            rx.hstack(
                rx.link(
                    rx.button(
                        rx.hstack(
                            rx.icon("eye", size=16),
                            rx.text("Visualizar", font_size="0.9375rem", font_weight="700"),
                            spacing="1", align="center"
                        ),
                    ...
                    href=rx.cond(
                        tesis["url"].to(str) != "",
                        tesis["url"].to(str) + "?token=" + EstadoAutenticacion.token_actual + "#toolbar=0",
                        "#"
                    ),
                    is_external=True,
                ...
                rx.cond(
                    ...
                    rx.button(
                        rx.hstack(
                            ...
                            rx.text("Descargar", font_size="0.9375rem", font_weight="700"),
                            spacing="1", align="center"
                        ),
                        on_click=rx.download(
                            url=tesis["url"].to(str) + "?token=" + EstadoAutenticacion.token_actual,
                ...
                width="100%", padding_top="0.75rem", spacing="3"
            ),
            height="100%", padding="1.5rem", border_radius="1rem",
    ...
    return rx.center(
        rx.vstack(
            rx.center(
                ...
                width="6rem", height="6rem", border_radius="1.5rem",
                background="rgba(99,102,241,0.06)",
                border="0.09375rem dashed rgba(99,102,241,0.22)",
            ),
            rx.vstack(
                rx.text("La bóveda está vacía", font_size="1.0625rem", font_weight="700",
                        color="#334155", text_align="center"),
                rx.text("Registra la primera tesis usando el botón de arriba.",
                        font_size="0.84375rem", color=COLOR_TEXTO_MUY_SUAVE, text_align="center"),
                spacing="1", align="center",
            ),
            width="100%", spacing="4", align="center", padding_bottom="0.625rem",
            direction={"initial": "column", "md": "row"},
        ),
        padding_y="5rem", width="100%",
    )
    ...
    return rx.vstack(
        rx.hstack(
            rx.center(
                ...
                width="1.625rem", height="1.625rem", border_radius="0.4375rem",
                background=DEGRADADO_ICONO, flex_shrink="0",
            ),
            rx.text(titulo, font_size="0.6875rem", font_weight="700",
                    color=COLOR_TEXTO_SUAVE, letter_spacing="0.07em",
                    text_transform="uppercase"),
            rx.box(flex="1", height="0.0625rem",
                ...
                rx.vstack(
                    rx.hstack(
                        rx.center(
                            ...
                            width="2.75rem", height="2.75rem", border_radius="0.8125rem",
                            background=DEGRADADO_ICONO,
                        ...
                        rx.vstack(
                            rx.text(
                                ...
                                font_size="1.125rem", font_weight="800", color=COLOR_TEXTO_TITULO,
                            ...
                            rx.text(rx.cond(EstadoBoveda.en_edicion, "Actualice la información del trabajo de grado.", "Ingrese la cédula para vincular al autor."),
                                    font_size="0.78125rem", color=COLOR_TEXTO_SUAVE),
                        ...
                        rx.icon_button(
                            ...
                            border_radius="0.5625rem", cursor="pointer",
                            on_click=EstadoBoveda.cerrar_modal,
                            _hover={
                    ...
                    rx.vstack(
                        ...
                        rx.grid(
                            ...
                            seccion_modal(
                                ...
                                rx.vstack(
                                    rx.text("Título de la Tesis", font_size="0.8125rem", font_weight="600", color=COLOR_TEXTO_TITULO),
                                    rx.text_area(
                                    ...
                                    rx.hstack(
                                        ...
                                        rx.text("Hacer pública en la biblioteca digital", font_size="0.8125rem", font_weight="600"),
                                        align="center", spacing="2", padding="0.75rem", bg="rgba(99,102,241,0.04)", border_radius="0.625rem", width="100%"
                                    ),
                                    spacing="3", width="100%",
                                ),
                                height="100%",
                            ...
                            rx.cond(
                                ...
                                rx.hstack(
                                    rx.center(
                                        ...
                                        background="rgba(99,102,241,0.1)", border_radius="0.625rem"
                                    ),
                                    rx.vstack(
                                        rx.foreach(
                                            rx.selected_files(
                                    ...
                                    border_radius="0.75rem", background="rgba(99,102,241,0.03)", align="center"
                                ),
                                rx.upload(
                                    rx.cond(
                                        EstadoBoveda.en_edicion & (
                                        ...
                                        rx.vstack(
                                            ...
                                            rx.text("Arrastra el PDF de la tesis o haz clic",
                                                    color="#64748B", font_size="0.8125rem"),
                ...
                rx.vstack(
                    rx.hstack(
                        rx.center(
                            ...
                            width="2.75rem", height="2.75rem", border_radius="0.75rem",
                        ...
                        width="100%", align="center", border_bottom="1px solid #E2E8F0", padding_bottom="1rem"
                    ),
                    rx.text(
                    ...
                    rx.hstack(
                        ...
                        rx.button(
                            "Eliminar Definitivamente", on_click=EstadoBoveda.confirmar_eliminacion_trabajo_de_grado,
                            variant="solid", color_scheme="red", size="3", cursor="pointer"
                        ),
                        justify="end", width="100%", spacing="3", padding_top="0.75rem"
                    ),
                    spacing="5", width="100%"
                ),
                padding="2rem", background="white", border_radius="1.25rem",
                width="min(32rem, 94vw)", position="fixed",
        ...
        rx.flex(  # Contenido de filtros y búsqueda
            ...
            rx.hstack(
                rx.center(
                    ...
                    width="1.75rem", height="1.75rem", border_radius="0.5rem",
                ...
                rx.vstack(
                    ...
                    rx.text(
                        ...
                        font_size="0.8125rem", color=COLOR_TEXTO_SUAVE,
                    ),
                ),
