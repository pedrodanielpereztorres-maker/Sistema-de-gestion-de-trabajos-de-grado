            ...
            rx.hstack(
                rx.cond(
                    ...
                    rx.link(
                        ...
                        href=rx.cond(doc.url != "", doc.url + "?token=" + EstadoAutenticacion.token_actual, "#"),
                        target="_blank",
                ...
                rx.icon_button(
                    ...
                    on_click=rx.cond(
                        doc.url != "",
                        rx.download(
                            url=doc.url + "?token=" + EstadoAutenticacion.token_actual, filename=f"{doc.titulo}.{doc.tipo}"),
                        None
                    ),
                    variant="solid",
                    color_scheme="blue",
                ...
                rx.grid(
                    ...
                    rx.cond(
                        ...
                        rx.center(
                            rx.vstack(
                                ...
                                rx.foreach(
                                    rx.selected_files("upload_docs"),
                                    lambda f: rx.text(
                                        f, weight="bold", color="#1E293B", text_align="center", key=f)
                                ),
                                rx.button(
                                    "Cambiar archivo",
                                ...
                                spacing="3", align="center", padding="1.875rem",
                                border="2px solid #4F46E5", border_radius="0.75rem",
                        ...
                        rx.upload(
                            ...
                            padding="1.875rem", border_radius="0.75rem",
                ...
                rx.vstack(
                    rx.hstack(
                        rx.center(
                            ...
                            width="2.5rem", height="2.5rem", border_radius="0.625rem",
...
def contenido_documentacion() -> rx.Component:
    ...
    return rx.vstack(
        ...
        width="100%", padding=["1rem", "1.25rem", "1.5rem", "1.5rem"],
        max_width="75rem", spacing="5",
