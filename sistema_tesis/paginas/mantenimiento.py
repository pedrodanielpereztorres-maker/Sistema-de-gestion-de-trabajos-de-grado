...
def barra_herramientas(titulo: str, placeholder_busqueda: str, valor_busqueda: rx.Var, setter_busqueda, texto_boton: str, icono_boton: str, accion_boton) -> rx.Component:
    return rx.hstack(
        ...
        width="100%", align="center", margin_bottom="1.25rem",
        padding_bottom="1.25rem", border_bottom=f"1px solid {COLOR_BORDE}"
    )
...
def celda_texto(texto: str, secundario: bool = False) -> rx.Component:
    return rx.table.cell(
        ...
        padding_y="1rem", padding_x="1.25rem"
    )
        ...
        rx.table.cell(
            rx.hstack(
                ...
                rx.icon_button(
                    ...
                    size="2",
                    cursor=rx.cond(EstadoAutenticacion.usuario_id == user.id, "not-allowed", "pointer"),
                    disabled=rx.cond(
...
def cabecera_modal(titulo: str, subtitulo: str, icono: str, on_close: rx.EventHandler) -> rx.Component:
    return rx.hstack(
        ...
        width="100%", align="center", margin_bottom="1.5rem",
        padding_bottom="1.25rem", border_bottom=f"1px solid {COLOR_BORDE}"
    )
...
def pie_modal(texto_guardar: str, accion_guardar: rx.EventHandler, accion_cancelar: rx.EventHandler) -> rx.Component:
    return rx.hstack(
        ...
        justify="end", width="100%", margin_top="1.5rem",
        padding_top="1.25rem", border_top=f"1px solid {COLOR_BORDE}"
    )
    ...
    return rx.cond(
        ...
        rx.box(
            ...
            rx.box(
                ...
                padding="1.5rem", background="white", border_radius="1rem",
                box_shadow=SOMBRA_MODAL, width="100%", max_width="34rem", z_index="210",
    ...
    return rx.cond(
        ...
        rx.box(
            ...
            rx.box(
                ...
                padding="1.5rem", background="white", border_radius="1rem",
                box_shadow=SOMBRA_MODAL, width="100%", max_width="28rem", z_index="210",
                position="fixed", top="50%", left="50%", transform="translate(-50%, -50%)",
                on_click=rx.stop_propagation
            )
        )
    ...
    return rx.cond(
        ...
        rx.box(
            ...
            rx.box(
                ...
                padding="1.5rem", background="white", border_radius="1rem",
                box_shadow=SOMBRA_MODAL, width="100%", max_width="31.25rem", z_index="210",
                position="fixed", top="50%", left="50%", transform="translate(-50%, -50%)",
                on_click=rx.stop_propagation
            )
        )
...
def contenido_mantenimiento() -> rx.Component:
    ...
    return rx.vstack(
        ...
        rx.tabs.root(
            rx.tabs.list(
                rx.tabs.trigger(
                    ...
                    padding_x="1.25rem", padding_y="0.625rem", color="#334155",
                    _active={
        ...
        toast_viewer(),
        modal_carrera(),
        width="100%", padding=["1.25rem", "1.75rem", "1.75rem", "2.25rem"],
        max_width="96vw",
