...
def fila_estudiante_lista(estudiante) -> rx.Component:
    ...
    return rx.box(
        rx.hstack(
            rx.center(
                rx.text(
                    inicial, color="white", font_weight="bold", font_size="0.75rem"
                ),
                width="2.25rem",
                height="2.25rem",
                border_radius="full",
        ...
        rx.vstack(
            ...
            rx.vstack(
                ...
                rx.text(
                    ...
                    weight="bold",
                    color=COLOR_TEXTO_BOLD,
                    style={"background_color": "transparent", "line_height": "1.05"},
                ),
                spacing="1",
                align="start",
            ),
...
def boton_accion_rapida(
    label: str, icono: str, color_scheme: str, on_click
) -> rx.Component:
    return rx.button(
        rx.hstack(
        ...
        rx.vstack(
            rx.hstack(
                rx.vstack(
                    ...
                    rx.text(
                        f"{valor_a_string(cantidad)} estudiantes",
                        size="2",
                        color="#475569",
                    ),
                    spacing="2",
                ...
                rx.badge(
                    ...
                    color_scheme=rx.cond(
                        valor_progreso >= 75,
                        "green",
                        rx.cond(valor_progreso >= 50, "orange", "red"),
                    ),
                    radius="full",
                    style={
                        "color": "white",
            ...
            rx.hstack(
                ...
                rx.spacer(),
                rx.text(
                    f"{valor_a_string(cantidad)} estudiantes", size="1", color="#64748B"
                ),
            ),
            spacing="5",
            width="100%",
        ...
        rx.vstack(
            rx.hstack(
                rx.vstack(
                    ...
                    rx.text(
                        "Las carreras con más estudiantes activos",
                        size="2",
                        color="#64748B",
                        font_weight="500",
                    ),
        ...
        rx.vstack(
            rx.hstack(
                ...
                rx.vstack(
                    ...
                    rx.text(
                        "Seguro, rápido y con control de privacidad",
                        size="2",
                        color="#64748B",
                        font_weight="500",
                    ),
            ...
            rx.grid(
                rx.card(
                    rx.vstack(
                        ...
                        rx.text(
                            "Acceso abierto para la comunidad académica",
                            size="1",
                            color="#64748B",
                            font_weight="500",
                        ),
    ...
    return rx.card(
        rx.vstack(
            ...
            rx.grid(
                ...
                boton_accion_rapida(
                    "Explorar Bóveda", "library", "indigo", rx.redirect("/boveda")
                ),
                boton_accion_rapida(
                    "Subir Guía PDF", "file-up", "blue", rx.redirect("/documentacion")
                ),
                boton_accion_rapida(
                    "Ver Documentación",
                    "file-text",
                    "blue",
                    rx.redirect("/documentacion"),
                ),
                boton_accion_rapida(
                    "Reporte General",
                    "file-down",
    ...
    return rx.card(
        rx.hstack(
            ...
            rx.vstack(
                ...
                rx.text(valor, size="3", weight="bold", color=COLOR_TEXTO_BOLD),
                spacing="0",
                align="start",
            ),
            spacing="3",
...
def encabezado_bienvenida() -> rx.Component:
    ...
    return rx.flex(
        rx.vstack(
            ...
            rx.text(
                "Panel central de control y seguimiento académico",
                color="#475569",
                size="3",
                font_weight="500",
            ),
...
def panel_administrador() -> rx.Component:
    ...
    return rx.vstack(
        rx.grid(
            tarjeta_estadistica(
                "Total Estudiantes",
                EstadoDashboard.total_estudiantes.to(str),
                "users",
                "linear-gradient(135deg, #6366F1, #3B82F6)",
            ),
            tarjeta_estadistica(
                "En Pasantía",
                EstadoDashboard.estudiantes_en_pasantia.to(str),
                "graduation-cap",
                "linear-gradient(135deg, #10B981, #059669)",
            ),
            tarjeta_estadistica(
                "Sin Pasantía",
                EstadoDashboard.estudiantes_sin_pasantia.to(str),
                "user-minus",
