    ...
    return rx.box(
        ...
        rx.vstack(
            ...
            rx.grid(
                ...
                kpi_card(
                    "Trabajos de Grado",
                    EstadoReportes.resumen_global.get("total_trabajos_de_grado"),
            ...
            seccion_reporte(
                ...
                rx.grid(
                    ...
                    tarjeta_exportacion(
                        "Bóveda de Trabajos de Grado",
                        "Registro completo de trabajos de grado del sistema.",
                        "library",
                        "#F59E0B",
                        "linear-gradient(135deg, #F59E0B, #D97706)",
                        accion_excel=EstadoReportes.exportar_trabajos_de_grado_excel,
                        accion_pdf=EstadoReportes.exportar_trabajos_de_grado_pdf,
                    ),
